...
public abstract class AbstractServiceJpa<T extends BaseEntity, R extends EntityRepository<T>> implements CrudService<T> {

    private final R repository;

    protected AbstractServiceJpa(R repository) {
